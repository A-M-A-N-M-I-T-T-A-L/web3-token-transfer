...
const Services = () => {
  return (
    <div className="flex flex-col md:flex-row w-full px-12 justify-center items-center gradient-bg-services">
      <div className="flex md:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
        <div className="flex-1 flex flex-col justify-start items-start">
          <h1 className="text-white text-4xl sm:text-7xl py-2 text-gradient">
            Services
          </h1>
        </div>
      </div>
