...
const Welcome = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-5 lg:p-16 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col md:mr-10">
          ...
          <div className="mt-10 grid sm:grid-cols-3 grid-cols-2 w-full rounded-2xl">
          ...
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
            <div className="flex justify-between flex-col w-full h-full">
              ...
              <div>
                ...
                <p className="text-white font-bold text-md mt-1">Ethereum</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {false ? (
              ...
              <button
                ...
                className="text-white w-full mt-2 border p-2 border-[#3d4f7c] rounded-full cursor-pointer hover:bg-white hover:text-[#3d4f7c] hover:border-white"
              >
                Send Now
              </button>
            )}
